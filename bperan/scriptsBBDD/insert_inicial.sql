...
INSERT INTO `bperan`.`empleado`(IDEMPLEADO,IDOBRA,NOMBRE,APELLIDOS,NIF,FECHANACIMIENTO,TELEFONO,DIRECCION,POBLACION,PROVINCIA,CODIGOPOSTAL,NACIONALIDAD,NUMSEGURIDADSOCIAL,TIPOCONTRATO,FECHAALTA,ESTADO,CATEGORIA)
VALUES(2,null,'Empleado 2','apellido2','88888888S','1975-09-12',777777777,'C/La Cámara, 5,8ªB','Avilés','Asturias',33400,'Española',3388888885475555125,'Fin Obra','2016-03-12','AA','capataz');

INSERT INTO `bperan`.`empleado`(IDEMPLEADO,IDOBRA,NOMBRE,APELLIDOS,NIF,FECHANACIMIENTO,TELEFONO,DIRECCION,POBLACION,PROVINCIA,CODIGOPOSTAL,NACIONALIDAD,NUMSEGURIDADSOCIAL,TIPOCONTRATO,FECHAALTA,ESTADO,CATEGORIA)
VALUES(3,2,'Empleado 3','apellido3','85479652P','1959-11-28',99999999,'C/Ezqurdia, 8,3ªA','Gijón','Asturias',33210,'Española',3300005487222215896,'Fin Obra','2016-03-12','AA','Peón');

INSERT INTO `bperan`.`empleado`(IDEMPLEADO,IDOBRA,NOMBRE,APELLIDOS,NIF,FECHANACIMIENTO,TELEFONO,DIRECCION,POBLACION,PROVINCIA,CODIGOPOSTAL,NACIONALIDAD,NUMSEGURIDADSOCIAL,TIPOCONTRATO,FECHAALTA,ESTADO,CATEGORIA)
VALUES(5,null,'Empleado 4','apellido4','2154865R','1955-01-27',655521586,'C/ los telares,9,4ºizda','Oviedo','Asturias',33009,'Española',33555577755444488844,'Fin Obra','2016-03-12','AA','peón');

-- Presupuesto
INSERT INTO `bperan`.`presupuesto`(IDPRESUPUESTO,IDOBRA,IDCLIENTE,COSTE_TOTAL,FECHA_INICIO,FECHA_FIN,ESTADO)
VALUES (1,1,1,10000.500,'2016-05-23','2017-05-23','AA');
